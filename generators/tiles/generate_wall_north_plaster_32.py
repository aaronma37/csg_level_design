...
def generate_wall_north_plaster_32():
    instructions = []
    ...
    # 2.3 Beams (Frame) - NO VERTICAL POSTS
    beam_thick = 12
    beam_h_dim = 6
    ...
    # Output
    data = {
        "name": "wall_north_plaster_32",
        "asset_tags": ["structure", "wall", "north", "plaster"],
    ...
    output_path = os.path.join(os.path.dirname(__file__), "../../csg/wall_north_plaster_32.json")
    with open(output_path, "w") as f:
        json.dump(data, f, indent=2)
    print(f"Generated {output_path}")

if __name__ == "__main__":
    generate_wall_north_plaster_32()
